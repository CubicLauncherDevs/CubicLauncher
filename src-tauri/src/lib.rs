...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::curseforge_pack::parse_curseforge_modpack_cmd,
            commands::curseforge_pack::download_curseforge_file,
            commands::curseforge_pack::install_curseforge_modpack,
